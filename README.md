...
For example, the branch [01-getting-started](https://github.com/Ibrar-Ahmed37/react-complete-guide-code/11-practice-food-order-app) holds all code snapshots and extra materials for section 1 of the course ("Getting Started").
